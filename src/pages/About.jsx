  ...
  return (
    <>
      <section className=" bg-[#FFFCF5]">
        <div className="px-6 py-10 lg:py-15 sm:px-15 xl:px-30">
          <div className="grid lg:grid-cols-3 gap-y-5">
            <div className="col-span-2">
              ...
              <h1 className="text-[#A5EB14] text-4xl lg:text-5xl font-bold leading-12 lg:leading-16">
                Bridg.Money
              </h1>
              <h1 className="text-4xl lg:text-5xl font-bold leading-12 lg:leading-16">
      ...
      <section className="mt-15 lg:mt-20 mb-20 lg:mb-30 px-6 sm:px-15 xl:px-30">
        <h1 className="text-center text-3xl md:text-5xl font-extrabold mb-4">
